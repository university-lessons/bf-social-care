    ...
    <div class="rounded bg-white p-4">
        ...
        <div class="flex flex-col justify-between sm:flex-row">
            <div class="flex items-center">
                ...
                <button type="submit"
                    class="flex h-8 w-12 cursor-pointer items-center justify-center rounded border-0 bg-emerald-500 text-white hover:bg-emerald-600 focus:outline-none">
            ...
            <a class="mt-4 inline-flex rounded border-0 bg-emerald-500 px-4 py-1 text-white hover:bg-emerald-600 focus:outline-none md:mt-0"
